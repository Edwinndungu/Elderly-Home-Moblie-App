package com.example.nyumbayawazeehomecare.Supplier;

import static com.example.nyumbayawazeehomecare.ConstFiles.Urls.URL_REGISTER_SUPPLIER;
...
import com.example.nyumbayawazeehomecare.Login;
...
public class RegisterSuppliers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register_suppliers);
    ...
    private void register() {
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_REGISTER_SUPPLIER,
                response -> {
