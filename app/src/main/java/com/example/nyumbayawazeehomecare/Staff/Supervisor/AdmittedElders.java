...
import static com.example.nyumbayawazeehomecare.ConstFiles.Urls.URL_ADMITTED;
...
public class AdmittedElders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admitted_elders);

        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setSubtitle("Admitted");
    ...
    private void getElders(){
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_ADMITTED,
                response -> {
