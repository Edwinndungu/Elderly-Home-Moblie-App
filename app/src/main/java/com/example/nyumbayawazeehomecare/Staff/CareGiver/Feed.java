...
import static com.example.nyumbayawazeehomecare.ConstFiles.Urls.URL_FEED;
...
import com.example.nyumbayawazeehomecare.Staff.CareGiver.Adaptor.AdaptorFeed;
...
public class Feed extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setSubtitle("Messages");
    ...
    private void getFeed(){
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_FEED,
                response -> {
                    ...
                    try {
                        ...
                        if(status.equals("1")){
                            ...
                            for(int i =0; i<jsonArray.length();i++){
                                ...
                                String memberID=jsn.getString("memberID");
                                String name=jsn.getString("name");
                                FeedModel model=new FeedModel(memberID,  name);
                                list.add(model);
                            }
                            adaptor=new AdaptorFeed(getApplicationContext(),list);
