package com.example.nyumbayawazeehomecare.Staff.Supervisor;

import static com.example.nyumbayawazeehomecare.ConstFiles.Urls.URL_GET_APPROVED_ELDERS;
...
import com.example.nyumbayawazeehomecare.Staff.Adaptors.AdaptorAddedElders;
import com.example.nyumbayawazeehomecare.Staff.Supervisor.Model.ModelElders;
...
public class EldersApproved extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_elders_approved);

        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setSubtitle("Approved");
    ...
    private void getElders(){
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_GET_APPROVED_ELDERS,
                response -> {
