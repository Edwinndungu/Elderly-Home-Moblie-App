...
import static com.example.nyumbayawazeehomecare.ConstFiles.Urls.URL_LAB_TEST;
...
import com.example.nyumbayawazeehomecare.Staff.Doctors.Adaptor.AdaptorLabTest;
...
public class LabTest extends AppCompatActivity {
    ...
    private AdaptorLabTest adaptor;
    ...
    private void getLabTest(){
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_LAB_TEST,
                response -> {
                    ...
                    try {
                        ...
                        if(status.equals("1")){
                            ...
                            adaptor=new AdaptorLabTest(getApplicationContext(),list);
