package com.example.nyumbayawazeehomecare.Staff.CareGiver;

import static com.example.nyumbayawazeehomecare.ConstFiles.Urls.URL_APPOINTMENTS;
...
import com.example.nyumbayawazeehomecare.Staff.Adaptors.AdaptorAppointments;
...
public class Appointments extends AppCompatActivity {
    ...
    private AdaptorAppointments adaptor;
    ...
    private void getElders(){
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_APPOINTMENTS,
                response -> {
                    ...
                    try {
                        ...
                        if(status.equals("1")){
                            ...
                            for(int i =0; i<jsonArray.length();i++){
                                ...
                                AppointmentsModel modelDate=new AppointmentsModel(appointmentID,  name, familyMember,  gender,  dob,
                                         appointmentDate,  appointmentStatus,appointmentDetails,  remarks);
                                list.add(modelDate);
                            }
                            adaptor=new AdaptorAppointments(getApplicationContext(),list);
