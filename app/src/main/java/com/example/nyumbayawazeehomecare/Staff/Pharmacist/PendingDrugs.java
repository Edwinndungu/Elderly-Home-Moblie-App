...
import static com.example.nyumbayawazeehomecare.ConstFiles.Urls.URL_DRUGS_PENDING;
...
public class PendingDrugs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pending_drugs);
        ...
        getSupportActionBar().setSubtitle("Drugs pending collection");
    ...
    private void getBookings(){
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_DRUGS_PENDING,
                response -> {
